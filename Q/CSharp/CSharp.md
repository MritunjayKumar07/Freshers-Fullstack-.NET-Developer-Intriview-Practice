...
Examples of managed code include C#, VB.NET, and other programming languages supported by .NET.
...
Each language's data types are converted into the CLR's data type system by their respective compilers, so the CLR understands its own data type system.
...
This is nothing but CLR or Common Language Runtime.
...
To allow developers to create reusable code that can be shared within their own projects or across multiple projects.
...
There are 16 versions of .NET Framework, ranging from 1.0 to 4.8.
...
### Q. How does CoreCLR relate to the .NET Framework CLR?
...
### Q. What makes .NET Core different from .NET Framework?
...
### Q. Which .NET Core versions are no longer supported?
...
### Q. Can developers still use the name “.NET Core” with .NET 5?
...
The Common Language Runtime (CLR) provides automatic memory management only for reference types. Value types are managed directly on the stack and do not require garbage collection.
...
### Q. What is a class library or assembly in .NET?
...
### Q. How do you change the Startup Object in Visual Studio?
...
### Q. Write a C# program to find the given number is even (or) Odd using switch case?
...
### Q. How to create a C# program that initializes an array with a user-defined size, accepts elements from the user, and prints the elements in reverse order?
...
Linear Search is a simple search algorithm that checks each element of the list sequentially until the desired element is found or the end of the list is reached.
...
`A.CopyTo(B, 0);` copies elements from A to B starting at index 0.
...
### Q. What is the Array Class in C#?
...
### Q. What is an example of data type widening in C#?
...
### Q. What is data type shortening?
...
### Q. What is an example of data type shortening in C#?
...
### Q. Why is implicit conversion not possible in type shortening?
...
### Q. What is the object type in C#?
...
### Q. Can you give examples of different data stored in an object?
...
### Q. What is the difference between storing data in an object type versus a specific type like int?

---

When you store data in an object type:

    <li>The actual data type is not known until runtime.</li>
    <li>You need to explicitly convert it back to its original data type if you want to perform operations on it.</li>
...
### Q. Can you perform operations directly on data stored in an object type?

---

No, you cannot directly perform operations on data stored in an object type. To do so, you must first convert it to its original data type using type conversion.

---

### Q. How do you perform operations on data stored in an object?
...
### Q. Why is type conversion necessary for object types when performing operations?
...
### Q. What is the difference between Implicit and Explicit Boxing?
...
### Q. What type of conversion is supported by Unboxing?
...
### Q. What are the internal steps performed during Boxing?
...
### Q. What happens internally during Unboxing?
...
### Q. Why is Boxing & Unboxing considered more costly than normal initialization?

---

    Boxing is costly because it involves copying the value from the stack to the heap, which takes more time and memory. It is said to be 20 times costlier than normal initialization.
...
### Q. When should you use Boxing and Unboxing?
...
### Q. What is the key difference between Boxing and Unboxing?
...
### Q. What is the nullable data type ?
...
### Q. What is Difference ToString() and Convert.ToString() ?

---

<b>ToString()</b> ⇒ It is one of the predefined method() which can be <mark>written within the class</mark>, return type is string

<b>Convert.ToString()</b> ⇒ Which is used to convert from one / any other data type to string data type
...
<b>Console.Write()</b>: Which is used to print the output & in console window after printing the line the cursor will remain in the same line

<b>Console.WriteLine()</b>: Which is used to print the output & in console window after printing the line the cursor will move to next line

---

### Q. What is the Difference Between Console.Read() and Console.ReadLine() and Console.ReadKey()?

---

<b>Console.Read()</b>: Which is used to read the single character from the console window in the form of character

<b>Console.ReadLine()</b>: Which is used to read the multiple character from the console window in the form of string

<b>Console.ReadKey()</b>: Which is used to stop console window / Output window until press the any key from the keyboard

---

### Q. What is Implicit Type Casting?
...
### Q. What are the two main programming approaches used in the industry?
...
### Q. What is Procedural Programming Approach?

---

Procedural Programming is a traditional approach used in the industry until the 1970s. Examples include COBOL, Pascal, FORTRAN, and C. In this approach, a program is a collection of members such as variables and functions, and these members are called explicitly for execution from the main function, which is the entry point of any program.

---

### Q. What are the drawbacks of Procedural Programming?

---

Lack of security: It does not provide mechanisms to protect data.

Lack of reusability: It does not support code reuse effectively.

---

### Q. What issue in Procedure-Oriented Programming does Object-Oriented Programming solve?
...
OOP is a paradigm/methodology/way of programming/approach of creating real-world applications, providing security, and building business applications.

---

### Q. What is Object-Oriented Programming (OOP) Approach?

---

Object-Oriented Programming (OOP) emerged in the late 1970s to overcome the limitations of procedural programming. Examples include C++, Python, Java, and C#. In OOP, a program is also a collection of variables and functions, but they are encapsulated within a class to provide security and reusability.
...
The key difference between OOP and procedural programming is that OOP introduces the concept of classes to encapsulate variables and functions. This provides:
...
### Q. What are the key components of Object-Oriented Programming in C#?
...
### Q. What are the four fundamental features of Object-Oriented Programming (OOP)?Expline it.
...
### Q. Under encapsulation, what are the following key things are involved?
...
### Q. Under Polymorphism, what are the following key things are involved?
...
### Q. What are the bulding block of OOP's?
...
- <details>
     <summary>What are the 6 pillars of OOP's?
...
### Q. What is the syntax & Example to create a class in C#?
...
### Q. What is instance and Refrence "Car car1 = new Car();"?
...
### Q. How is a class represented in C#?
...
### Q. What is the by default access modifier of class?
...
### Q. What is the by default access modifier of default/implicitly constructor?
...
### Q. What is the by default access modifier class member?
...
### Q. What is Implicit/default constructor and Explicit constructor?
...
### Q. One static class and in side the static class `non-static` member are available. Is that posible to access the static member?

---

    No, First things you can't create the static member in static class and you can't create the instance of static class.

---

### Q. How many type of constructor?
...
### Q. What is Default or Parameter less constructor ?
...
---
    ...
    > Refers to the current instance of the class.  It acts as a reference to the current object, allowing access to the object's members (fields, properties, methods) and constructors.
...
Create multiple instances with the same value

In a copy constructor the constructor take the same class as a parameter to it.
...
### Q. Is that posible to overloading the Static constructors?
...
### Q. What is Prevent Instantiation and Singleton Pattern?
...
### Q. Those constructor which is declared using the static modifier are called what?
...
### Q. Who initializing the Static or Non-Static Variable/Fields?
...
### Q. Who Called the Static and Non-Static constructor?

---

Static constructors are called implicitly by the .NET runtime when the class is first accessed, whereas non-static constructors are called explicitly when an instance of the class is created.
...
<b>Non-Static Constructors: </b>These are explicitly called when you create an instance of the class using the new keyword. For example, MyClass obj = new MyClass(); explicitly calls the non-static constructor of MyClass.

    </hr>

### Q. Which Constructors execute first Static or `non-static` constructors?
...
### Q. How many time execute static and non-static constructor?

---

In the life cycle of class, the static constructor executes only once, whereas the non-static constructor executes zero times if no instances are created and 'n' times if 'n' instances are created.

---

### Q. Can Static and non-static members are access directly?

---

Static members can be accessed directly, whereas non-static members cannot be accessed directly.</br>

Because static members instances are shared among all of a class. While non-static members belong to individual instances.

    </br>

Only one copy of the static members.

---

### Q. Can be static constructor parametrized?

---

Non-static constructor can be parametrized but static constructor can't have parametrized. Because of static constrctor is implicitly call & wo will pass the parameter. Remember static constructor is a 1st block of code to run the class.

---

### Q. Is that posible to overloade the static constructor?
...
### Q. When Constructor is Implicitly call?

---

Every class contains an implicit constructor if not defined explicitly constructor.

    </br>

You can't create an instance of static class. They can't have instance constructors, whether implicit or explicit. However, they can have static constructors to initialize static members.

---

### Q. When Static constructor implicitly defined by compiler?
...
Special method used to clean up an object before the garbage collector reclaims it.

It runs automatically when the object is no longer needed.

Destructor's name is the same as the class name, but with a tilde (~) at the beginning.
...
### Q. Destructors have any access modifiers?

---

No, destructors do not have access modifiers and are implicitly private.

---

### Q. Destructors take any Parameters?

---

No, destructors cannot take parameters.

---

### Q. Can it posible destructor overloading?

---

Not posible, a class can only have one destructor.

---

### Q. Who and when called the destructor?

---

Destructors are called automatically by the garbage collector when an object is no longer needed.

---

### Q. Explain the relationship between classes and data types. How can a class, whether predefined or user-defined, be considered a data type?

---

## https://codecomponents.hashnode.dev/advance-c-sharp-proggramming-language#heading-variable-instance-amp-refrence-of-class

### Q. If I inherit a class and both classes have constructors, which class constructor is called first?

---

The parent class constructor is called first, then the child class constructor. This is because the child class constructor implicitly calls the parent class constructor before executing its own code.

---

### Q. If I inherit a class and both classes have the same method, which class method is called first?

---

The child class method is called first because the object is created the child class. If an object is created the parent class, then the parent class method is called.

---

### Q. Why is the main function outside the class in C++?
...
### Q. How does Java handle the main method differently from C++?
...
### Q. How does C# mirror Java's approach to the main method?
...
### Q. Can a class with only the main method run without an instance?
...
### Q. How to write programs using C#?
...
### Q. What happens when an object to the class is created?
...
### Q. What is WriteLine, Write, Read, ReadLine, ReadKey & Clear methods?
...
### Q. What are the two reason for using Namespace?
...
### Q. How to solve preventing naming collisions problome?
...
### Q. How to Use Namespaces in Code?
...
### Q. What Happens When Two Namespaces Contain the Same Type?
...
### Q. What is the Code of User-Define Namespace?
...
### Q. How many type of Directives in C#?
...
### Q. What are the primitive/pre-defined Data type?
...
### Q. Where all the primitive/pre-defined datatype define?
...
### Q. What happens to C# types after compilation?
...
### Q. What’s the difference between signed and unsigned integer types?
...
### Q. What is the Guid type used for?
...
### Q. What is Unicode and how does it differ from ASCII?
...
### Q. What is special about the string type?
...
### Q. What is special about the `object` type?
...
### Q. How do we declare fields and variables in C#?
...
### Q. What are modifiers, const, and readonly keywords?
...
### Q. Why do we use suffixes like f and m for float and decimal values?
...
### Q. What does the GetType method do?
...
### Q. What are implicitly typed variables?
...
### Q. What is the diffrence bitween Var and Dunamic type?
...
### Q. Give me the example of Var and dynamic type?
...
### Q. What is Boxing and Un-Bixing?
...
### Q. How can we take input from users in a C# program?
...
### Q. What are the 3 actions performed by `Console.ReadLine()`?
...
### Q. Why do we need to convert the input from `Console.ReadLine()`?
...
### Q. How do we convert the string input to other types?
...
### Q. What is the Parse() method used for?
...
### Q. What are the different ways to format strings in C#?
...
### Q. What does the `is` operator do?
...
### Q. What are the different ways of converting an object to a string?
...
### Q. Can you change the type of a variable after declaration in C#?
...
### Q. Differences between for loop and foreach loop in accessing values of an array or collection?
...
### Q. What are the some Arry Class and Properties?
...
### Q. How to convert string to character array and char array to string?
...
### Q. How does the Main method accept command line arguments?
...
### Q. Can you give an example of passing command line arguments to a program?
...
### Q. Can we pass different types of values (int, double, string) as command line arguments?
...
### Q. What is the length of the args array if no command line arguments are passed?
...
### Q. How do you loop through all command line arguments in the args array?
...
### Q. Can you give an example of adding numbers passed as command line arguments?
...
### Q. Can we pass multiple command line arguments?
...
### Q. What is the issue if multiple classes have Main methods in a C# project?
...
### Q. How can we resolve the "multiple entry points" error?
...
### Q. How do you set the `Startup Object` property in Visual Studio?
...
### Q. What if we don't want to set the StartupObject manually?
...
### Q. What is the purpose of the .csproj file in a C# project?
...
### Q. How to use consume another class method?
...
### Q. What is member object operators?
...
### Q. How can you consume a type in programming?
...
### Q. What is the difference between variables and objects?
...
### Q. What is the conclusion regarding consuming classes or structures?
...
### Q. What are the user-defined type "members" in a "class" in C#?
...
### Q. What are the categori of method?
...
### Q. What is the syntax to define a method?
...
### Q. Give me the example of value-returning and non-value returning methods?
...
### Q. What are the possible return types for a method?
...
### Q. What is the syntax to pass parameters to a method?
...
### Q. Where should we define methods?
...
### Q. How do you execute a method defined in a class?
...
### Q. How do you call a method defined in a class?
...
### Q. Where should an instance of a class be created?
...
### Q. Can you provide an example code that demonstrates method definitions and instantiation of a class & characteristics of the methods?
...
### Q. What are the main way te consumed from other classes in C#?
...
### Q. Can you provide an example of consuming a class by creating an instance?
...
### Q. Can multiple classes be defined in a single .cs file?
...
### Q. It is posible to execute have scenario like "multiple main method in diffrent class but in same `.cs` file one main method calling another main method because of static"?
...
### Q. Give me the example of a user-defined return type in a method?
...
### Q. Why do we define parameters for methods?
...
### Q. What is the syntax for defining parameters in a method?
...
### Q. What are the classifications of method parameters?
...
### Q. How are input, output, and InOut parameters declared?
...
### Q. What is `ref` Parameters? Give example.
...
### Q. What is `out` Parameters? Give example.
...
### Q. Can you provide an example of `InOut` parameters?
...
### Q. What does the `params` keyword do in a method?
...
### Q. In method signature which position use params?
...
### Q. What is the diffrence bitween ref and out parameter?
...
### Q. How can default values be assigned to method parameters?
...
### Q. What is a variable of a class?
...
### Q. Can a variable of a class, call own members of the class?
...
### Q. What happens when you assign `null` to an instance?
...
### Q. Can multiple instances of a class affect each other's members?
...
### Q. What are the steps that happen internally when an instance of a class is created?
...
### Q. What happens when a reference is used to access class members?
...
### Q. What is de-referencing an instance?
...
### Q. What happens when null is assigned to a reference?
...
### Q. What is the diffrence bitween Variable of class, Instance of class and Reference of a class?
...
### Q. Can we create an instance of a class without a constructor?
...
### Q. What happens if we don't define a constructor explicitly?
...
### Q. What does an implicit constructor look like?
...
### Q. How does the implicit constructor initialize fields?
...
### Q. Can we define our own constructors?
...
### Q. What happens when we define an explicit constructor?
...
### Q. What is the syntax to define an explicit constructor?
...
### Q. How do we call a constructor?
...
### Q. What is the difference between an instance and a reference in terms of constructor calling?
...
### Q. When constructors must be called explicitly or called implicitly?
...
### Q. What is the difference between a default and parameterized constructor?
...
### Q. Why should constructors be defined `explicitly` in a class?
...
### Q. What is the significance of the `this` keyword in a constructor?
...
### Q. Give me the example of `Parameterized Constructors`?
...
### Q. Give me example of Explicit Constructor for Dynamic Initialization?
...
### Q. Why is dynamic initialization important?
...
### Q. What is the static modifier in C#?
...
### Q. What are the two categories of class members?
...
### Q. How is a non-static field different from a static field?
...
### Q. When are static fields and non-static fields initialized?
...
### Q. How many times do static and non-static fields get initialized?
...
### Q. What is the best place to initialize non-static fields?
...
### Q. Can static fields be initialized through a constructor?
...
### Q. How does static block initialization work?
...
### Q. What is a constant field in C#?
...
### Q. What is a readonly field, and how is it different from a constant field?
...
### Q. What is the Difference bitween Constant & Readonly fields?
...
### Q. When are static, constant, non-static, and readonly fields initialized?
...
### Q. How can you access static, constant, and non-static fields in or outside of the class?
...
### Q. What is the difference between non-static and static methods in C#?
...
### Q. What is a static constructor, and how is it different from a non-static constructor?
...
### Q. What is the diffrence bitwee static & non-static Constructor?
...
### Q. Can you modify static and constant fields in C#?
...
### Q. What is a static class in C#, and how does it work?
...
### Q. When are implicit constructors defined in a class?
...
### Q. What is an entity in the context of application development?
...
### Q. How do you identify the attributes of an entity?
...
### Q. How do you design a database for an entity-based application?
...
### Q. How do you design an application to manage entities and their attributes?
...
### Q. Can a child class access the private members of its parent class?
...
### Q. How do you define and test inheritance in C#?
...
### Q. What are the key points to remember when testing inheritance in C#?
...
### Q. What is the 1 rule of inheritance related to constructors?
...
### Q. Why does the child class constructor call the parent class constructor?
...
### Q. What is the 2 rule, Can a parent class access members of the child class?
...
### Q. How can we test that a parent class cannot access child class members?
...
### Q. What is the 3 rule,Can a child class instance be assigned to a parent class reference?
...
### Q. Can a child class variable be initialized by a parent class instance?
...
### Q. How can we initialize a child class variable using a parent class reference?
...
### Q. What is the 4 rule, What is the default parent class of every class in .NET?
...
### Q. What are the types of inheritance in Object-Oriented Programming (OOP)?
...
### Q. What is the 5 rule, Do .NET and Java support multiple and hybrid inheritance?
...
### Q. What is the 6 rule,How can a child class call a parent class constructor with parameters?
...
### Q. How is inheritance used in application development?
...
### Q. Diffrence bitween Method Overloading vs Method Overriding
...
### Q. How inheritance work based on Overloading?
...
### Q. Give me Example of Inheritance-Based Overloading and Overriding:
...
### Q. Can we override any parent classes’ methods under child classes without declaring them as virtual?
...
### Q. Can we re-implement any parent classes’ methods under the child classes without declaring them as virtual?
...
### Q. What is Method Hiding/Shadowing?
...
### Q. How can we test Hiding/Shadowing in C#?
...
### Q. What approaches are available to call parent class methods from the child class after re-implementing them?
...
### Q. Can a parent class reference access methods purely defined in a child class?
...
### Q. What is Static or Compile-time Polymorphism?
...
### Q. What are the differences between Static and Dynamic Polymorphism?
...
### Q. How is the behavior for an operator defined?
...
### Q. What is the syntax of an Operator Method?
...
### Q. Can you give examples of pre-defined operator methods in C#?
...
### Q. How can you test Operator Overloading in a class?
...
### Q. What is the significance of Dynamic Polymorphism in this context?
...
### Q. How does Constructor Overloading work?
...
### Q. What are the ways to initialize the fields in the Overloading Constructor class?
...
### Q. What is the purpose of using this keyword in the constructors?
...
### Q. How can Constructor Overloading reduce code duplication?
...
### Q. What would happen if no constructor was defined in the class?
...
### Q. How is the Copy Constructor defined?
...
### Q. What is the main feature of a Copy Constructor that distinguishes it from creating a reference?
...
### Q. Can a Copy Constructor be implicitly provided by the compiler?
...
### Q. Why are Static Constructors not parameterized or overloaded?
...
### Q. What are the 5 types of constructors, and what do they do?
...
### Q. Can a Sealed Class be inherited?
...
### Q. Can the members of a Sealed Class be used in other classes?
...
### Q. Can any method of a class be overridden by a child class?
...
### Q. What happens when a `virtual` method is overridden in a child class?
...
### Q. Can a child class seal an overridden method?
...
### Q. Can a method be sealed without being overridden first?
...
### Q. When to apply sealed modifier?
...
### Q. Can a method sealed in one class be overridden in a class further down the hierarchy?
...
### Q. Why would you use a Sealed Class or a Sealed Method?
...
### Q. Do child classes need to implement all abstract methods of an abstract class?
...
### Q. Can an abstract class contain non-abstract (concrete) methods?
...
### Q. What is the use of abstract methods in application development?
...
### Q. What happens if a child class does not implement all the abstract methods from the parent class?
...
### Q. Can abstract classes have fields?
...
### Q. What is the difference between abstract methods and virtual methods?
...
### Q. Can an abstract class have static methods?
...
### Q. Give me example of Abstract class & method?
...
### Q. Can it's mendatry if any abstract method in a class is there, then class shood automatically be abstract class and it's mendatry to use abstract modifier in class?
...
### Q. How is an interface different from a non-abstract class and an abstract class?
...
### Q. What is the difference between inheriting a class and implementing an interface?
...
### Q. Why does .NET not support multiple inheritance through classes, but supports it through interfaces?
...
### Q. What is the syntax to define an interface?
...
### Q. What are the key points about interfaces?
...
### Q. How can multiple inheritance be implemented using interfaces in .NET?
...
### Q. Provide an example of implementing multiple interfaces in .NET.
...
### Q. How can you use interface references to call methods implemented in a class?
...
### Q. How can a class inherit from an interface and a base class at the same time in C#?
...
### Q. Why is the "I" prefix commonly used for interfaces in C#?
...
### Q. Can inteface contain constructor?
...
### Q. What are the differences in Class and Structure?
...
### Q. What is the syntax to define a structure in C#?
...
### Q. How do you add a structure to a project?
...
### Q. Provide an example of a simple structure definition in C#.
...
### Q. How can a structure be consumed in C#?
...
### Q. Provide an example of consuming a structure from another structure or class.
...
### Q. Can structures support inheritance?
...
### Q. What types of members can be defined in a structure?
...
### Q. How does memory allocation differ between structures and classes?
...
### Q. What happens if you do not initialize the fields of a structure?
...
### Q. Can you create a default constructor in a structure?
...
### Q. What happens when you create a new project in Visual Studio?
...
### Q. Can a solution contain projects written in different .NET languages?
...
### Q. How do you add a new project to an existing solution?
...
### Q. How do you run a specific project in a solution with multiple projects?
...
### Q. How are solutions and projects saved on disk?
...
### Q. What types of assembly files are generated in .NET Framework and .NET Core?
...
### Q. What is the difference between an ".exe" and a ".dll" assembly?
...
### Q. Can you consume classes from one project in another project?
...
### Q. Can you add references to both .dll and .exe assemblies in .NET Framework and .NET Core?
...
### Q. How do you add a reference to an assembly in a project?
...
### Q. How many Access Specifiers are supported in C#?
...
### Q. What is the default access modifier of inside the namespace?
...
### Q. What is the default access specifier for members in a class or structure?
...
### Q. Can we declare a types(like: class) as private, protected, or protected internal of namespace?
...
### Q. What is the default access modifier of constructor?
...
### Q. What is the default access specifier for a type?
...
### Q. Whic access modifier where accessable?
...
### Q. Give me example of using all access modifier?
...
### Q. What is Language Interoperability in .NET?
...
### Q. What are the differences between VB.NET and C#?
...
### Q. How to create a Visual Basic project to test interoperability?
...
### Q. How to consume VB.NET code in C#?
...
### Q. What are the two types of assemblies in .NET?
...
### Q. How do you create a private assembly?
...
### Q. How can you check the location of the generated assembly?
...
### Q. How do you consume a private assembly in multiple projects?
...
### Q. How can you verify that multiple copies of the private assembly were created?
...
### Q. What is the advantage of a private assembly?
...
### Q. What is the drawback of a private assembly?
...
### Q. Why are multiple copies of a shared assembly not created?
...
### Q. Who can add or delete files from the GAC?
...
### Q. How can you make an assembly shared?
...
### Q. How do you install an assembly into the GAC?
...
### Q. How to open Visual/Developer Studio Command Prompt?
...
### Q. What type of assembly can be installed into the GAC?
...
### Q. What are the components of a strong name?
...
### Q. Why is a public key required for a strong name?
...
### Q. What are the benefits of a strong name?
...
### Q. How do you generate a public key for a strong name?
...
### Q. How do you generate a public key for a shared assembly?
...
### Q. How do you create a shared assembly?
...
### Q. How do you install the assembly into GAC?
...
### Q. How do you test the shared assembly?
...
### Q. What is versioning in assemblies?
...
### Q. How can you view and edit assembly attributes in the .csproj file?
...
### Q. Where do you find the key file information in the .csproj file?
...
### Q. Why do we maintain version numbers for an assembly?
...
### Q. What are the criteria for changing the version number of an assembly?
...
### Q. Where do you change the version number of an assembly?
...
### Q. How do you test the process of changing the version number of an assembly?
...
### Q. Can the Global Assembly Cache (GAC) store multiple versions of the same assembly?
...
### Q. How do you test side-by-side execution(run both version) of assemblies?
...
### Q. What are the four sections of an assembly?
...
### Q. What information does the Assembly Manifest contain?
...
### Q. What information does Type Metadata provide?
...
### Q. What are the benefits of metadata in assemblies?
...
### Q. What is the role of CIL (Common Intermediate Language) in the compilation of .NET programming languages, and how does it ensure platform independence?
