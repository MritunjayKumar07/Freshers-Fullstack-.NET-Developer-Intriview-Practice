...
![Theory 01](../Images/SQL%20Server/Theory%2001.png)
...
- <details>
  ...
  ![OLTP_OLAP](../Images/SQL%20Server/OLTP_OLAP.png)
...
| **Data Operations** | Performs CRUD (Create, Read, Update, Delete) | Read-heavy operations with complex queries |
| **Data Volume** | Handles a large volume of small transactions | Handles a large volume of historical data |
| **Data Structure** | Highly normalized to reduce redundancy | Denormalized with multi-dimensional schemas |
| **Query Type** | Simple, short queries | Complex queries for analysis |
| **Performance Focus** | Optimized for transaction speed | Optimized for query performance |
| **Examples** | Banking systems, order entry systems | Data warehouses, BI tools |
| **Users** | Clerks, front-line workers | Analysts, managers, executives |
| **Transaction Nature** | Short and frequent | Long and less frequent |
| **Data Integrity** | Very critical | Less critical |
...
- <details>
    ...
    ![DVA_VS_Developer](../Images/SQL%20Server/DBA_Developer.png)
...
- <details>
  ...
  ![Client](../Images/SQL%20Server/Client.png)
...
- <details>
  ...
  ![Client-Server](../Images/SQL%20Server/Client_Server.png)
...
- <details>
  ...
  ![SQL](../Images/SQL%20Server/SQL.png)
...
- <details>
  ...
  ![Data_&_DataDefination](../Images/SQL%20Server/Data&DataDefination.png)
...
- <details>
    ...
    ![Data-type](../Images/SQL%20Server/Datatype.png)
...
- <details>
  ...
  **Example**:
  ...
  _`Scenario`_: If an account has loans, it cannot be closed.
    <hr/>
  </details>
